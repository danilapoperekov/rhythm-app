const CACHE = 'rhythm-shell-v12';
const ASSETS = ['./', './index.html', './styles.css', './config.js', './app.js', './js/core.js', './js/audio-store.js', './js/backup-crypto.js', './js/api-client.js', './manifest.webmanifest', './icon.svg'];
